...
$needsSharedDrawerTrigger = empty($userPage['show_header'])
    && (string)($userPage['key'] ?? '') !== 'dashboard';
?>
<?php if ($needsSharedDrawerTrigger): ?>
<button id="openSidebarBtn" class="icon-btn user-drawer-page-trigger hidden" type="button" aria-label="Open menu" aria-controls="sidebar" aria-expanded="false">
...
<aside id="sidebar" class="sidebar user-drawer" role="dialog" aria-modal="true" aria-label="User menu" aria-hidden="true" inert tabindex="-1">
  <a class="drawer-profile-fixed" href="/user/profile" aria-label="Open profile">
    ...
    <span class="drawer-profile-orb drawer-orb-three" aria-hidden="true"></span>
  ...
  <div class="drawer-menu-scroll" aria-label="Menu options">
    <div class="drawer-menu-section">
      ...
      <div class="drawer-section-card">
        <a class="side-btn user-drawer-item" href="/user/profile" data-drawer-page="profile">
        ...
        <a class="side-btn user-drawer-item" href="/user/profile#security" data-drawer-page="security">
    ...
    <div class="drawer-menu-section">
      ...
      <div class="drawer-section-card">
        <a class="side-btn user-drawer-item" href="/user/notifications" data-drawer-page="notifications">
    ...
    <div class="drawer-menu-section">
      ...
      <div class="drawer-section-card">
        <a class="side-btn user-drawer-item" href="/user/contact-us" data-drawer-page="contact-us">
        ...
        <a class="side-btn user-drawer-item" href="/user/support" data-drawer-page="support">
        ...
        <a class="side-btn user-drawer-item drawer-link" href="/privacy" target="_blank" rel="noopener">
        ...
        <a class="side-btn user-drawer-item drawer-link" href="/terms" target="_blank" rel="noopener">
    ...
    <div class="drawer-menu-section">
      ...
      <div class="drawer-section-card">
        <div class="side-btn user-drawer-item drawer-version" aria-label="App version 1.0.0">
          ...
          <span class="drawer-menu-copy"><strong>App Version</strong><small>Web 1.0.0</small></span>
          <span class="drawer-chevron" aria-hidden="true"></span>
        </div>
      </div>
    </div>

    <button id="drawerLogoutBtn" class="side-btn user-drawer-item drawer-logout" type="button">
