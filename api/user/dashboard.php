...
<section id="overviewSection" class="page-section dashboard-scroll-body active" aria-busy="true">
  ...
  <div id="zpayQuickActions" class="zpay-quick-card dashboard-recommended">
    ...
    <div class="zpay-service-grid">
      ...
      <a class="zpay-service-btn zpay-service-btn-znews" href="/user/znews" aria-label="Z Sky 24"><span class="zpay-service-icon" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M4 4h16v16H4V4Zm3 3v2h7V7H7Zm0 4v2h10v-2H7Zm0 4v2h10v-2H7Zm9-8v2h1V7h-1Z"/></svg></span><span class="zpay-service-name">Z Sky 24</span></a>
