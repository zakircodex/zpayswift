...
function user_login_issue_session(array $user, string $uid, string $deviceId, string $deviceName): string
{
...
if (user_login_has_valid_trusted_device($uid, $trustedDeviceCookie)) {
    $sessionToken = user_login_issue_session($user, $uid, $deviceId, $deviceName);
...
$otpRow = [
    ...
    'masked_phone'   => user_login_mask_phone($phone),
    'status'         => 'SENT',
    'used'           => false,
    'created_at'     => $now,
