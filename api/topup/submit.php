...
$hold = wallet_hold_amount($uid, $walletDebit, $operationRef, 'ANDROID_TOPUP_HOLD', [
    ...
    'ledger_extra' => [
        ...
        'service_amount_bdt' => (float)($financials['service_amount_bdt'] ?? $financials['topup_amount_bdt'] ?? 0),
...
$pendingExtra = [
    ...
    'service_amount_bdt' => (float)($preview['service_amount_bdt'] ?? $financials['service_amount_bdt'] ?? $financials['topup_amount_bdt'] ?? 0),
