...
switch ($action) {
    ...
    case 'support_reply_upload':
        ...
        proxy_response(true, !empty($result['duplicate']) ? 'ADMIN_SUPPORT_REPLY_DUPLICATE' : 'ADMIN_SUPPORT_REPLY_SENT', !empty($result['duplicate']) ? 'Support reply already sent.' : 'Support reply sent.', [
