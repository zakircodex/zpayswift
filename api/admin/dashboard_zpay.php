 ...
 *
 * This file keeps the original dashboard.php untouched and injects
 * Z-Pay Swift branding, the bKash/Nagad admin link and UX loader at render time.
 */
...
if (strpos($html, 'admin-dashboard-ux.js') === false) {
    $html = str_replace(
        '</body>',
        '<script src="/zawtopup/api/admin/assets/admin-dashboard-ux.js?v=1"></script>' . "\n" . '</body>',
        $html
    );
}
