...
$payload = [
    ...
    'whatsapp_enabled' => support_bool($body['whatsapp_enabled'] ?? ($existing['whatsapp_enabled'] ?? false), false),
    'whatsapp_number' => support_clean_phone($body['whatsapp_number'] ?? ($existing['whatsapp_number'] ?? '')),
    'call_enabled' => support_bool($body['call_enabled'] ?? ($existing['call_enabled'] ?? false), false),
    'support_phone' => support_clean_phone($body['support_phone'] ?? ($existing['support_phone'] ?? '')),
    'email_enabled' => support_bool($body['email_enabled'] ?? ($existing['email_enabled'] ?? false), false),
    'support_email' => $email,
