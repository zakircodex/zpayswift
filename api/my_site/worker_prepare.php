...
$previewMode = (bool)($body['preview_mode'] ?? false);
if ($planStatus !== 'PAID_ACTIVE' && !$previewMode) {
    api_response(false, 'WORKER_LOCKED', 'Worker app requires active subscription', ['plan_status' => $planStatus], 403);
}
...
$row = [
    ...
    'status' => $previewMode ? 'PREVIEW_BUILD_READY' : 'BUILD_READY',
