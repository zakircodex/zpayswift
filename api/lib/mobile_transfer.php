...
function zpay_transfer_public_row(array $row): array
{
    ...
    return [
        ...
        'sender_name' => zpay_dash_clean_string((string)($row['sender_name'] ?? ''), 80),
        'sender_account' => zpay_dash_mask_phone((string)($row['sender_account'] ?? $row['sender_phone'] ?? '')),
        'receiver_name' => zpay_dash_clean_string((string)($row['receiver_name'] ?? ''), 80),
        'receiver_account' => zpay_dash_mask_phone((string)($row['receiver_account'] ?? $row['receiver_phone'] ?? '')),
        'counterparty_name' => zpay_dash_clean_string((string)($isCredit ? ($row['sender_name'] ?? '') : ($row['receiver_name'] ?? '')), 80),
