...
<head>
  ...
  <link rel="stylesheet" href="/api/subadmin/assets/subadmin.css?v=22">
...
<div id="appView">
  <div class="wrap">
    ...
    <div class="app-shell">
      ...
      <aside class="sidebar">
        <button id="closeSubSidebarBtn" class="mobile-drawer-close mobile-only" type="button" aria-label="Close menu">&times;</button>
...
<div id="deductConfirmModalWrap" class="modal-wrap">
  <div class="modal-card modal-card-sm">
    ...
    <div class="field">
      ...
      <input id="deductOtpCodeInput" class="input" maxlength="6" inputmode="numeric" autocomplete="one-time-code" placeholder="Enter 6 digit OTP">
    </div>
...
<div id="createUserOtpModalWrap" class="modal-wrap">
  <div class="modal-card modal-card-sm">
    ...
    <div class="field">
      <label>OTP Code</label>
      <input id="createUserOtpCode" class="input" maxlength="6" inputmode="numeric" autocomplete="one-time-code" placeholder="Enter 6 digit OTP">
    </div>
...
<script src="/api/subadmin/assets/subadmin.js?v=22"></script>
