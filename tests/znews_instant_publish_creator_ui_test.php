...
$textDecision = znews_post_publication_decision([]);
...
foreach ([$createService, $updateService, $createEndpoint, $updateEndpoint, $mediaPolicy, $webCreator] as $source) {
    instant_expect(
...
instant_expect(str_contains($createService, 'znews_post_publication_decision'), 'create service bypasses publication policy');
instant_expect(str_contains($createService, 'znews_path_public_feed($postId)'), 'create service lacks public-feed write');
instant_expect(str_contains($updateService, 'znews_post_publication_decision'), 'update service bypasses publication policy');
