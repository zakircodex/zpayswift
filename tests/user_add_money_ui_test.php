...
expect_add_money(str_contains($dashboard, '/api/user/assets/user-app.css?v=28') && str_contains($dashboard, '/api/user/assets/dashboard.js?v=34'), 'Add Money asset cache bust versions were not bumped');
