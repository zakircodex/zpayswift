...
expect_add_money(
    ...
    && str_contains($css, 'padding: max(10px, env(safe-area-inset-top)) 0 28px')
    && str_contains($css, 'top: max(8px, env(safe-area-inset-top))')
    && str_contains($css, 'margin: 0 0 14px')
    && !str_contains($css, '.add-money-page-header::before')
