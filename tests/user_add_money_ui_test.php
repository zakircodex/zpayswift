...
expect_add_money(str_contains($dashboard, '/api/user/assets/user-app.css?v=32') && str_contains($dashboard, '/api/user/assets/dashboard.js?v=36'), 'Add Money asset cache bust versions were not bumped');
