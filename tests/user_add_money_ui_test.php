...
expect_add_money(str_contains($dashboard, 'id="addMoneyOpenBtn"') && str_contains($dashboard, 'id="addMoneyReloadBtn"'), 'Add Money/Reload tabs are missing');
expect_add_money(str_contains($dashboard, 'role="tablist"'), 'Add Money tabs do not expose a tablist');
