...
zsky_expect(str_contains($api, "znews/reviews/mine.php"), 'Weekly creator report must remain under the allowed Z News API namespace.');
...
zsky_expect(str_contains($embeddedWorker, 'zsky24-embedded-shell-v30'), 'Embedded PWA namespace is missing.');
...
zsky_expect(str_contains($standaloneWorker, 'zsky24-standalone-shell-v30'), 'Standalone PWA namespace is missing.');
...
zsky_expect(str_contains($embeddedWorker, 'znews-weekly-review.js?v=4'), 'Embedded worker is missing the creator weekly report asset.');
zsky_expect(str_contains($standaloneWorker, 'znews-weekly-review.js?v=4'), 'Standalone worker is missing the creator weekly report asset.');
