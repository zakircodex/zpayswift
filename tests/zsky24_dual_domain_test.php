...
zsky_expect(str_contains($embeddedWorker, 'zsky24-embedded-shell-v26'), 'Embedded PWA namespace is missing.');
...
zsky_expect(str_contains($standaloneWorker, 'zsky24-standalone-shell-v26'), 'Standalone PWA namespace is missing.');
