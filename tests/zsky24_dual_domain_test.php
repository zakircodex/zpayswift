...
zsky_expect(str_contains($embeddedWorker, 'zsky24-embedded-shell-v29'), 'Embedded PWA namespace is missing.');
...
zsky_expect(str_contains($standaloneWorker, 'zsky24-standalone-shell-v29'), 'Standalone PWA namespace is missing.');
...
zsky_expect(str_contains($embeddedWorker, 'znews-weekly-review.js?v=3'), 'Embedded worker is missing the creator weekly report asset.');
zsky_expect(str_contains($standaloneWorker, 'znews-weekly-review.js?v=3'), 'Standalone worker is missing the creator weekly report asset.');
