...
zsky_expect(str_contains($embeddedWorker, 'zsky24-embedded-shell-v6'), 'Embedded PWA namespace is missing.');
zsky_expect(str_contains($standaloneWorker, 'zsky24-standalone-shell-v6'), 'Standalone PWA namespace is missing.');
