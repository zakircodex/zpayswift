...
$expect(str_contains($sw, "const SHELL_REVISION = 'creator-ui-polish-2'"), 'Service worker revision must refresh creator UI assets without regressing the reader.');
$expect(str_contains($sw, "const CACHE_NAME = 'zsky24-embedded-shell-v24'"), 'Embedded shell cache namespace is incorrect.');
