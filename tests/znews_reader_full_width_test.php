...
$expect(str_contains($sw, "const SHELL_REVISION = 'back-navigation-guard-1'"), 'Service worker revision must refresh the Back navigation behavior.');
$expect(str_contains($sw, "const CACHE_NAME = 'zsky24-embedded-shell-v8'"), 'Embedded shell cache namespace is incorrect.');
