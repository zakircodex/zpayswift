...
$expect(str_contains($sw, "const SHELL_REVISION = 'weekly-creator-review-1'"), 'Service worker revision must refresh the weekly-report shell without regressing the reader.');
$expect(str_contains($sw, "const CACHE_NAME = 'zsky24-embedded-shell-v15'"), 'Embedded shell cache namespace is incorrect.');
