...
$expect(str_contains($sw, "const SHELL_REVISION = 'fast-boot-1'"), 'Service worker revision must refresh the fast boot without regressing the reader.');
$expect(str_contains($sw, "const CACHE_NAME = 'zsky24-embedded-shell-v18'"), 'Embedded shell cache namespace is incorrect.');
