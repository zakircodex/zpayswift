...
$expect(str_contains($sw, "const SHELL_REVISION = 'reader-full-width-1'"), 'Service worker revision must refresh the cached reader stylesheet.');
$expect(str_contains($sw, "const CACHE_NAME = 'znews-shell-v9'"), 'Existing shell cache contract unexpectedly changed.');
