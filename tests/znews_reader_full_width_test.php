...
$expect(str_contains($sw, "const SHELL_REVISION = 'headline-photo-layout-1'"), 'Service worker revision must refresh the compact composer assets.');
$expect(str_contains($sw, "const CACHE_NAME = 'zsky24-embedded-shell-v5'"), 'Embedded shell cache namespace is incorrect.');
