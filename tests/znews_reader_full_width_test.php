...
$expect(str_contains($sw, "const SHELL_REVISION = 'fixed-composer-media-1'"), 'Service worker revision must refresh the compact composer assets.');
$expect(str_contains($sw, "const CACHE_NAME = 'zsky24-embedded-shell-v6'"), 'Embedded shell cache namespace is incorrect.');
