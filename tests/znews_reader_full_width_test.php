...
$expect(str_contains($sw, "const SHELL_REVISION = 'my-posts-navigation-loading-1'"), 'Service worker revision must refresh the My Posts behavior.');
$expect(str_contains($sw, "const CACHE_NAME = 'zsky24-embedded-shell-v7'"), 'Embedded shell cache namespace is incorrect.');
