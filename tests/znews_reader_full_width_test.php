...
$expect(str_contains($sw, "const SHELL_REVISION = 'reload-guest-bootstrap-1'"), 'Service worker revision must refresh the reload-safe reader behavior.');
$expect(str_contains($sw, "const CACHE_NAME = 'zsky24-embedded-shell-v14'"), 'Embedded shell cache namespace is incorrect.');
