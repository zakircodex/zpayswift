...
$expect(str_contains($sw, "const SHELL_REVISION = 'priority-feed-1'"), 'Service worker revision must refresh the priority feed without regressing the reader.');
$expect(str_contains($sw, "const CACHE_NAME = 'zsky24-embedded-shell-v17'"), 'Embedded shell cache namespace is incorrect.');
