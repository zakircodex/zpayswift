...
$expect(str_contains($sw, "const SHELL_REVISION = 'adsterra-cross-origin-frame-v1'"), 'Service worker revision must refresh Adsterra assets without regressing the reader.');
$expect(str_contains($sw, "const CACHE_NAME = 'zsky24-embedded-shell-v33'"), 'Embedded shell cache namespace is incorrect.');
