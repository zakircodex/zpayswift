...
$expect(str_contains($sw, "const SHELL_REVISION = 'categories-device-share-v1'"), 'Service worker revision must refresh current assets without regressing the reader.');
$expect(str_contains($sw, "const CACHE_NAME = 'zsky24-embedded-shell-v36'"), 'Embedded shell cache namespace is incorrect.');
