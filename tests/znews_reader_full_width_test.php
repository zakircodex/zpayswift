...
$expect(str_contains($sw, "const SHELL_REVISION = 'rich-editor-ui-1'"), 'Service worker revision must refresh rich-text/My Posts assets without regressing the reader.');
$expect(str_contains($sw, "const CACHE_NAME = 'zsky24-embedded-shell-v23'"), 'Embedded shell cache namespace is incorrect.');
