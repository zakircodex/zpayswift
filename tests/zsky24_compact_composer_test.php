...
composer_expect(str_contains($index, 'znews.js?v=31'), 'Latest composer behavior is not loaded.');
...
foreach ([$embeddedWorker, $standaloneWorker] as $worker) {
    ...
    composer_expect(str_contains($worker, 'znews.js?v=31'), 'Latest app behavior is missing from a PWA shell.');
