...
composer_expect(str_contains($bootstrap, 'znews.js?v=15'), 'Latest composer behavior is not loaded.');
...
foreach ([$embeddedWorker, $standaloneWorker] as $worker) {
    ...
    composer_expect(str_contains($worker, 'znews.js?v=15'), 'Latest app behavior is missing from a PWA shell.');
