...
check(str_contains($index, 'znews-bootstrap.js?v=12'), 'Latest bootstrap is not activated');
...
check(str_contains($serviceWorker, "const CACHE_NAME = 'zsky24-embedded-shell-v8'"), 'Embedded reader shell cache is stale');
check(str_contains($serviceWorker, 'znews-bootstrap.js?v=12'), 'Latest bootstrap is missing from cache');
