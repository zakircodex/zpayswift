...
$expect(str_contains($index, 'znews-config.js?v=10'), 'Profile-photo config cachebuster is missing.');
$expect(str_contains($index, 'znews-bootstrap.js?v=36'), 'Reload-safe bootstrap cachebuster is missing.');
