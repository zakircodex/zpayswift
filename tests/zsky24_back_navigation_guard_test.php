...
back_guard_expect(str_contains($index, 'znews.js?v=29'), 'The guarded app script is not activated.');
...
back_guard_expect(str_contains($embeddedWorker, "zsky24-embedded-shell-v31"), 'The embedded cache namespace is stale.');
back_guard_expect(str_contains($standaloneWorker, "zsky24-standalone-shell-v31"), 'The standalone cache namespace is stale.');
