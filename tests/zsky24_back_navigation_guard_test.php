...
back_guard_expect(str_contains($bootstrap, 'znews.js?v=15'), 'The guarded app script is not activated.');
back_guard_expect(str_contains($index, 'znews-bootstrap.js?v=17'), 'The guarded bootstrap is not activated.');
back_guard_expect(str_contains($embeddedWorker, "zsky24-embedded-shell-v11"), 'The embedded cache namespace is stale.');
back_guard_expect(str_contains($standaloneWorker, "zsky24-standalone-shell-v11"), 'The standalone cache namespace is stale.');
