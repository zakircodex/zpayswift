...
back_guard_expect(str_contains($bootstrap, 'znews.js?v=17'), 'The guarded app script is not activated.');
back_guard_expect(str_contains($index, 'znews-bootstrap.js?v=18'), 'The guarded bootstrap is not activated.');
