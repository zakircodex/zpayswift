...
back_guard_expect(str_contains($index, 'znews.js?v=24'), 'The guarded app script is not activated.');
back_guard_expect(str_contains($index, 'znews-bootstrap.js?v=28'), 'The reload-safe guarded bootstrap is not activated.');
back_guard_expect(str_contains($bootstrap, 'znews-weekly-review.js?v=1'), 'The weekly performance route guard is not activated.');
back_guard_expect(str_contains($embeddedWorker, "zsky24-embedded-shell-v23"), 'The embedded cache namespace is stale.');
back_guard_expect(str_contains($standaloneWorker, "zsky24-standalone-shell-v23"), 'The standalone cache namespace is stale.');
