...
zsky24_reload_expect(str_contains($index, 'znews-api.js?v=19'), 'API cache-busting revision was not advanced');
zsky24_reload_expect(str_contains($index, 'znews-bootstrap.js?v=38'), 'bootstrap cache-busting revision was not advanced');
...
zsky24_reload_expect(str_contains($index, 'defer src="/znews/assets/znews.js?v=34"'), 'deferred app shell revision was not advanced');

foreach ([$standaloneSw, $embeddedSw] as $sw) {
    zsky24_reload_expect(str_contains($sw, 'shell-v37'), 'service worker cache generation was not advanced');
    ...
    zsky24_reload_expect(str_contains($sw, 'znews-api.js?v=19'), 'service worker API revision does not match index');
    ...
    zsky24_reload_expect(str_contains($sw, 'znews-bootstrap.js?v=38'), 'service worker bootstrap revision does not match index');
zsky24_reload_expect(str_contains($sw, 'znews-ads.js?v=6'), 'service worker ad shell revision does not match index');
    ...
    zsky24_reload_expect(str_contains($sw, 'znews.js?v=34'), 'service worker app revision does not match index');
