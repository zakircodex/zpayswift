...
zsky24_reload_expect(str_contains($index, 'znews-config.js?v=10'), 'config cache-busting revision was not advanced');
zsky24_reload_expect(str_contains($index, 'znews-api.js?v=18'), 'API cache-busting revision was not advanced');
zsky24_reload_expect(str_contains($index, 'znews-bootstrap.js?v=37'), 'bootstrap cache-busting revision was not advanced');
zsky24_reload_expect(str_contains($bootstrap, 'znews-weekly-review.js?v=4'), 'weekly creator report cache-busting revision is missing');
...
zsky24_reload_expect(str_contains($index, 'defer src="/znews/assets/znews.js?v=33"'), 'deferred app shell revision was not advanced');

foreach ([$standaloneSw, $embeddedSw] as $sw) {
    zsky24_reload_expect(str_contains($sw, 'shell-v36'), 'service worker cache generation was not advanced');
    ...
    zsky24_reload_expect(str_contains($sw, 'znews-config.js?v=10'), 'service worker config revision does not match index');
    zsky24_reload_expect(str_contains($sw, 'znews-api.js?v=18'), 'service worker API revision does not match index');
    ...
    zsky24_reload_expect(str_contains($sw, 'znews-bootstrap.js?v=37'), 'service worker bootstrap revision does not match index');
zsky24_reload_expect(str_contains($sw, 'znews-ads.js?v=6'), 'service worker ad shell revision does not match index');
    ...
    zsky24_reload_expect(str_contains($sw, 'znews.js?v=33'), 'service worker app revision does not match index');
