...
zsky24_reload_expect(str_contains($index, 'znews-bootstrap.js?v=24'), 'bootstrap cache-busting revision was not advanced');
...
foreach ([$standaloneSw, $embeddedSw] as $sw) {
    zsky24_reload_expect(str_contains($sw, 'shell-v19'), 'service worker cache generation was not advanced');
    ...
    zsky24_reload_expect(str_contains($sw, 'znews-bootstrap.js?v=24'), 'service worker bootstrap revision does not match index');
