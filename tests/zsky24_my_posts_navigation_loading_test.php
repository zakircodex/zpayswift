...
my_posts_expect(str_contains($embeddedWorker, "zsky24-embedded-shell-v20"), 'Embedded cache namespace is stale.');
my_posts_expect(str_contains($standaloneWorker, "zsky24-standalone-shell-v20"), 'Standalone cache namespace is stale.');
