...
my_posts_expect(str_contains($bootstrap, 'znews.js?v=17'), 'Latest navigation behavior is not activated.');
...
my_posts_expect(str_contains($embeddedWorker, 'znews.js?v=17') && str_contains($embeddedWorker, 'znews-creator.js?v=7'), 'Embedded shell is missing the updated scripts.');
my_posts_expect(str_contains($standaloneWorker, 'znews.js?v=17') && str_contains($standaloneWorker, 'znews-creator.js?v=7'), 'Standalone shell is missing the updated scripts.');
