...
edit_composer_expect(str_contains($index, 'znews-bootstrap.js?v=17'), 'Latest edit bootstrap is not activated.');

foreach ([$embeddedWorker, $standaloneWorker] as $worker) {
    edit_composer_expect(str_contains($worker, 'znews-bootstrap.js?v=17'), 'A PWA shell is missing the edit bootstrap.');
