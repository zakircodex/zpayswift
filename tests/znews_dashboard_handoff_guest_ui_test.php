...
znews_contract_expect(str_contains($index, 'znews-bootstrap.js?v=9'), 'Latest handoff bootstrap must be activated.');
...
znews_contract_expect(str_contains($serviceWorker, 'zsky24-embedded-shell-v4'), 'Embedded PWA cache namespace is missing.');
