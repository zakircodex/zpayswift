...
znews_contract_expect(str_contains($index, 'znews-bootstrap.js'), 'Handoff bootstrap must load before the main app.');
...
znews_contract_expect(str_contains($serviceWorker, 'znews-shell-v5'), 'PWA cache must include the latest header/access model.');
