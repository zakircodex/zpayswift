...
znews_contract_expect(str_contains($index, 'znews-bootstrap.js?v=14'), 'Latest handoff bootstrap must be activated.');
...
znews_contract_expect(str_contains($serviceWorker, 'zsky24-embedded-shell-v10'), 'Embedded PWA cache namespace is missing.');
