...
znews_contract_expect(str_contains($index, 'znews-bootstrap.js?v=31'), 'Reload-safe handoff bootstrap must be activated.');
...
znews_contract_expect(str_contains($serviceWorker, 'zsky24-embedded-shell-v26'), 'Current embedded PWA cache namespace is missing.');
