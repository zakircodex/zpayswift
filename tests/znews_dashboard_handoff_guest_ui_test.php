...
znews_contract_expect(str_contains($index, 'znews-bootstrap.js?v=34'), 'Reload-safe handoff bootstrap must be activated.');
znews_contract_expect(str_contains($bootstrap, 'znews-weekly-review.js?v=3'), 'Creator weekly report module must remain available after verified access.');
...
znews_contract_expect(str_contains($serviceWorker, 'zsky24-embedded-shell-v29'), 'Current embedded PWA cache namespace is missing.');
znews_contract_expect(str_contains($serviceWorker, 'znews-reader.js?v=4'), 'Latest reader module must be cached.');
znews_contract_expect(str_contains($serviceWorker, 'znews-weekly-review.js?v=3'), 'Creator weekly report module must be cached.');
