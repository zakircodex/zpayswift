...
znews_contract_expect(str_contains($index, 'znews-bootstrap.js?v=27'), 'Reload-safe handoff bootstrap must be activated.');
...
znews_contract_expect(str_contains($serviceWorker, 'zsky24-embedded-shell-v22'), 'Current embedded PWA cache namespace is missing.');
