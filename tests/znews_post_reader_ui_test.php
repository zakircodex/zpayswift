...
reader_expect(str_contains($index, 'znews-bootstrap.js?v=26'), 'Reload-safe reader bootstrap version is not activated.');
...
reader_expect(str_contains($serviceWorker, "const CACHE_NAME = 'zsky24-embedded-shell-v21'"), 'Mobile viewport PWA cache version is stale.');
...
reader_expect(str_contains($serviceWorker, 'znews-bootstrap.js?v=26'), 'Reload-safe bootstrap is missing from the shell cache.');
