...
reader_expect(str_contains($index, 'znews-bootstrap.js?v=17'), 'Latest reader bootstrap version is not activated.');
...
reader_expect(strpos($bootstrap, 'znews-reader.js?v=3') < strpos($bootstrap, 'znews.js?v=14'), 'Reader API capture must load before the main app.');
