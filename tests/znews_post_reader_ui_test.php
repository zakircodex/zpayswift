...
reader_expect(str_contains($index, 'znews-bootstrap.js?v=15'), 'Latest reader bootstrap version is not activated.');
...
reader_expect(strpos($bootstrap, 'znews-reader.js?v=3') < strpos($bootstrap, 'znews.js?v=12'), 'Reader API capture must load before the main app.');
...
reader_expect(str_contains($serviceWorker, 'znews-bootstrap.js?v=15'), 'Latest bootstrap is missing from the shell cache.');
