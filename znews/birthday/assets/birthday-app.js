(() => {
  ...
  async function preparePhotoUpload(file) {
    ...
    try {
      ...
      const attempts = [
        { edge: 1440, type: 'image/webp', quality: .78 },
        { edge: 1280, type: 'image/webp', quality: .68 },
        { edge: 1120, type: 'image/webp', quality: .6 },
        { edge: 960, type: 'image/jpeg', quality: .56 },
        { edge: 840, type: 'image/jpeg', quality: .5 },
        { edge: 720, type: 'image/jpeg', quality: .44 },
        { edge: 640, type: 'image/jpeg', quality: .38 },
        { edge: 560, type: 'image/jpeg', quality: .34 },
        { edge: 480, type: 'image/jpeg', quality: .3 },
        { edge: 400, type: 'image/jpeg', quality: .26 },
        { edge: 320, type: 'image/jpeg', quality: .24 }
      ];
      ...
      throw new Error('This photo could not be reduced to 100 KB safely. Please choose another photo.');
    } catch (error) {
