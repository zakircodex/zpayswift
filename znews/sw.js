...
const CACHE_NAME = 'zsky24-embedded-shell-v5';
const SHELL_REVISION = 'headline-photo-layout-1';
const SHELL = [
  '/znews/',
  '/znews/index.html',
  '/znews/assets/znews.css?v=2',
  '/znews/assets/znews-premium.css?v=7',
