...
const CACHE_NAME = 'zsky24-standalone-shell-v27';
const SHELL_REVISION = 'rich-editor-single-surface-1';
const SHELL = [
  '/',
  '/znews/index.html',
  ...
  '/znews/assets/znews-bootstrap.js?v=32',
