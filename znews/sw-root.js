...
const CACHE_NAME = 'zsky24-standalone-shell-v28';
const SHELL_REVISION = 'weekly-performance-premium-1';
const SHELL = [
  '/',
  '/znews/index.html',
  ...
  '/znews/assets/znews-weekly-review.css?v=2',
  '/znews/assets/znews-config.js?v=9',
  '/znews/assets/znews-api.js?v=14',
  '/znews/assets/znews-weekly-review.js?v=2',
  '/znews/assets/znews-ads.js?v=2',
  '/znews/assets/znews-rich-editor.js?v=5',
  '/znews/assets/znews-bootstrap.js?v=33',
