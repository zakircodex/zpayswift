...
const CACHE_NAME = 'zsky24-standalone-shell-v36';
const SHELL_REVISION = 'categories-device-share-v1';
const SHELL = [
  '/',
  '/znews/index.html',
  '/znews/assets/znews.css?v=6',
